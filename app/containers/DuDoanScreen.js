...
class DuDoanScreen extends Component {
	...
	getData() {
		...
		fetch('https://api.rss2json.com/v1/api.json?rss_url=http%3A%2F%2Fxosodaiphat.com%2Fdu-doan-kqxs-2011.rss' , {
			method: 'GET',
		})
	...
	render() {
		...
		console.log('nguyenvandsa', this.state.data)
		return (
...
export default connect(mapStateToProps)(DuDoanScreen)